...
В hack.txt. Что изменилось? Почему? Как сделать так, чтобы страница отображалась корректно?
---
...
NodeJS имеет модульную структуру. */
```
```JS
var http = require('http');
/*Обращение к модулю –
вызов метода createServer.
*/
